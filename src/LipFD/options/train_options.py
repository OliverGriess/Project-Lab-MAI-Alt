...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--loss_freq', type=int, default=10,
        ...
        parser.add_argument('--pretrained_model', type=str, default="./checkpoints/model_epoch_29.pth",
                            help='model will fine tune on it if fine-tune is True')
        ...
        parser.add_argument('--k', type=float, default=7.5)
