...
from OLD.localisation.preprocessed_dataloader import Preprocessed_LAVDF
from OLD.dataloader.LAV_DF import LAV_DF, create_lav_df_dataloader
...
def validate(model, loader, gpu_id):
    ...
    np.savetxt(
        "/work/scratch/kurse/kurs00079/om43juhy/Project-Lab-MAI-Alt/y_true.txt",
        y_true,
        fmt="%f",
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_root",
        type=str,
        default="/work/scratch/kurse/kurs00079/data/LAV-DF/LipFD_preprocess",
    )
    parser.add_argument(
        "--data_root_lavdf",
        type=str,
        default="/work/scratch/kurse/kurs00079/data/LAV-DF",
    )
    parser.add_argument(
